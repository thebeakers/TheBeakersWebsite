// src/routes/earth/+page.server.ts
...
export const load: ServerLoad = async () => {
    const categoryName = "earth"; // CHANGED (assuming 'earth science' maps to 'earth' slug)
    const pageTitle = "Earth Science"; // Display title
    const categoryTomlArticles = await getArticlesByCategory(categoryName); // Fetch by 'earth'
